...
class MusashinoLibrary:
    ...
    def rentlist(self):
        ...
        rentnumber = driver.find_element_by_xpath('//*[@id="honbun"]/div/div/div/div/section[2]/section[1]/dl/dt').text
        ...
        driver.find_element_by_partial_link_text(u"貸出状況照会").click()        
    ...
    def reserveBooks(self):
        driver = self.driver
        driver.find_element_by_partial_link_text(u"予約状況照会").click()

        driver.find_element_by_link_text(u"マイライブラリ").click()
        reservenumber = driver.find_element_by_xpath('//*[@id="honbun"]/div/div/div/div/section[2]/section[2]/dl/dt').text
        pattern = "\s*(?P<number>\d+)件"
